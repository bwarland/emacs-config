...
(setq org-capture-templates
      (quote (
	      ...
	      ("jb" "biodrivstoff" plain (file+olp "~/GitHub/Notater/møter/wmm.org" "biofuels")
	       "** %?\n ")
	      ("jc" "råolje")
	      ("jcp" "pris" plain (file+olp "~/GitHub/Notater/møter/wmm.org" "crude oil" "Prices")
	       "%?\n%c ")
	      ("jcf" "forsyning" plain (file+olp "~/GitHub/Notater/møter/wmm.org" "crude oil" "Supply and Market Balance")
	       "%?\n%c ")
	      ("jh" "handelsflyt" plain (file+olp "~/GitHub/Notater/møter/wmm.org" "tradeflow and fuel substitution")
	       ...
	       "%?\n%c ")
	      ("jo" "opex")
	      ("jop" "prisutvikling" plain (file+olp "~/GitHub/Notater/møter/wmm.org" "Opex" "Price")
	       "%?\n%c ")
	      ("jof" "gassforsyning" plain (file+olp "~/GitHub/Notater/møter/wmm.org" "Opex" "Gas Supply")
	       "%?\n%c ")
	      ("joe" "ETS" plain (file+olp "~/GitHub/Notater/møter/wmm.org" "Opex" "ETS")
	       "%?\n%c ")
	      ("jp" "produkter")
