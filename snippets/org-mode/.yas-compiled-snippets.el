...
(yas-define-snippets 'org-mode
		     '((">wmm" "* Crude Oil\n** Supply And Market Balance\n** Prices\n* Storage\n* Tradeflow And Fuel Substitution\n* Products\n** Gasoline\n** Diesel\n** Jet\n** Fuel Oil\n** LPG \n** Nafta\n* Opex\n** Gas Supply\n** ETS\n** Price\n* Refinery\n** Throughput\n** Margins\n** Outage\n** Gas Supply\n** Market\n** Tax and Energy Savings\n** ETS\n* Biofuels" "Weekly Market Meeting" nil nil nil "/home/bw/GitHub/emacs-config/snippets/org-mode/wmm" nil nil)
		       ...
		       (">vn" "[[file:/home/bw/Documents/Marked/Vietnam/rapporter/${1:filnavn}.pdf][$1]$0\n" "Vietnam" nil nil nil "/home/bw/GitHub/emacs-config/snippets/org-mode/vietnam" nil nil)
		       ...
		       (">pykonv" "# filename: $1\n# purpose: $2\n# created: $3\n# by: $4\n\n# This Python script aims for following naming rules:\n# \n# 1) functions: verb, lower case with underscore if more than one word\n# 2) variables: noun, lower case with underscore if more than one word\n# 3) data structures: noun, lower case with underscore if more than one word\n# 4) objects: noun, CamelCase\n# 5) constants: noun, upper case with underscore if more than one word\n\n$5\n" "navnekonvensjoner for python" nil nil nil "/home/bw/GitHub/emacs-config/snippets/org-mode/pykonv" "C-z" nil)
