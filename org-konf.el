...
(setq org-capture-templates
      (quote (
	      ...
	      ("jrh" "high end of barrel" plain (file+datetree+prompt "~/GitHub/Notater/journaler/rpm-high.org")
	       "%c \n- %?")
	      ("jrl" "low end of barrel" plain (file+datetree+prompt "~/GitHub/Notater/journaler/rpm-low.org")
	       "%c \n- %?")
	      ("jrl" "middle of barrel" plain (file+datetree+prompt "~/GitHub/Notater/journaler/rpm-middle.org")
	       "%c \n- %?")
                     )))
