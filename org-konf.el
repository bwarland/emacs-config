...
(setq org-capture-templates
      (quote (
              ("h" "handling")
              ("ha" "ad-hoc" entry (file+olp "~/GitHub/Notater/journaler/gjøre-frister.org" "ad-hoc")
               "* TODO %?\nSCHEDULED: %^t")
	      ("hb" "Power-Bi" entry (file+olp "~/GitHub/Notater/journaler/gjøre-frister.org" "prosjekter" "Power-BI")
	       "* TODO %?\nSCHEDULED: %^t")
	      ("he" "Emacs" entry (file+olp "~/GitHub/Notater/journaler/gjøre-frister.org" "prosjekter" "Emacs")
	       "* TODO %?\nSCHEDULED: %^t")
              ("hm" "møter" entry (file+olp "~/GitHub/Notater/journaler/gjøre-frister.org" "møter")
	       "* %?\nSCHEDULED: %^T--%^T")
	      ("hp" "Python" entry (file+olp "~/GitHub/Notater/journaler/gjøre-frister.org" "prosjekter" "Python")
               "* TODO %?\nSCHEDULED: %^t")
              ("j" "Journal")
