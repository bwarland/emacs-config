...
(setq org-capture-templates
      (quote (
	      ...
	      ("rb" "bolt" table-line (file+headline "~/GitHub/Journal/helse.org" "bolt")
	       "|%^u|%?|%?|%?|%?|%?|" :prepend t)
	      ("rh" "hvilepuls" table-line (file+headline "~/GitHub/Journal/helse.org" "hvilepuls")
	       "|%^u|%?|" :prepend t)
	      ("rH" "håndstyrke" table-line (file+headline "~/GitHub/Journal/helse.org" "håndstyrke")
	       "|%^u|%?|%?|" :prepend t)
	      ("rm" "markløft" table-line (file+headline "~/GitHub/Journal/helse.org" "markløft")
	       "|%^u|%?|%?|" :prepend t)
	      ("rs" "søvn" table-line (file+headline "~/GitHub/Journal/helse.org" "søvn")
	       "|%^u|%?|" :prepend t)
                     )))
