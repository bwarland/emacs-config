...
(cond ((eq system-type 'windows-nt) (set-frame-font "Consolas-12"))
...
(use-package org
  ...
  (setq org-hide-leading-stars t
	...
	org-todo-fast-selection t
	org-log-done 'note
	;; org-todo-keywords (quote (
	;; 			  (sequence "TODO(t)" "|" "DONE(d)" "DISCARDED(D)")
	...
	org-todo-keyword-faces (quote (
				       ...
				       ("CANC" :foreground "dark green" :background "white")
				       ("WAIT" :foreground "dark green" :background "white")
	...
	org-tag-faces (quote (
			      ;; ("historie" :foreground "red" :background "white")
	...
	org-agenda-span 5
	org-agenda-tags-tags-column -50
	org-agenda-block-seperators t
	org-agenda-compact-blocks t
	org-agenda-include-deadlines t
	org-agenda-window-set-up 'current-window
	...
	org-capture-templates (quote (
					...
					;;  "* %?\n")
				      ...
				      ("jj" "journal" entry (file+datetree+prompt "C:\\Users\\bjorwa\\Documents\\GitHub\\Markedsanalyse\\journaler\\journal.org")
				       "***** TODO %?\n")
				      ("t" "tabell")
				      ("ta" "price quote agencies" table-line (file+olp "C:\\Users\\bjorwa\\Documents\\GitHub\\Markedsanalyse\\journaler\\LNG-daglig.org" "LNG" "Price")
				       "|%^u|%^{Platts}|%^{Argus}|%^{ICIS}|" :prepend t)
				      ("tb" "LNG benchmark" entry (file+olp "~/notebook/markedsvurdering.org" "dagsrapport")
				       "* %^u \nyjkm%?" :prepend t)
				      ("td" "deal/price" table-line (file+olp "C:\\Users\\bjorwa\\Documents\\GitHub\\Markedsanalyse\\journaler\\LNG-daglig.org" "LNG" "Deals")
...
(use-package org-super-agenda
  ...
  (setq org-super-agenda-groups
	'((:name "TIDSPLAN" :time-grid t)
	  (:name "SORTERING" :todo "TODO")
	  (:name "Bangladesh" :tag "bangladesh")
	  (:name "Pakistan" :tag "pakistan"))))
...
(setq initial-buffer-choice "C:\\Users\\bjorwa\\Documents\\GitHub\\Markedsanalyse\\journaler\\LNG-daglig.org")
